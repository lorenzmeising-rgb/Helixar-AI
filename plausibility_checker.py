...
KNOWN_PROCESSES: Dict[str, Dict[str, Dict[str, Any]]] = {
    ...
    # ============================================================
    # Extension P2 — coverage for the remaining DB molecules so step-count
    # plausibility runs across all 79 entries, not just the demo subset.
    # ============================================================

    # ---------- small_molecule / volatile (bulk solvents & fermentation alcohols) ----------
    "methanol": {
        "chemical": {"steps": (1, 2),
                     "note": {"de": "Erdgas-Dampfreformierung → Synthesegas → Cu/ZnO-katalysierte Hydrierung zu MeOH.",
                              "en": "Natural-gas steam reforming → syngas → Cu/ZnO-catalysed hydrogenation to MeOH."},
                     "literature_source": "Ullmann's Encyclopedia of Industrial Chemistry — Methanol (doi:10.1002/14356007.a16_465.pub3)"},
    },
    "acetone": {
        "chemical": {"steps": (1, 2),
                     "note": {"de": "Cumol-Hydroperoxid-Spaltung (Hock-Prozess) liefert Aceton + Phenol als Koppelprodukte.",
                              "en": "Cumene hydroperoxide cleavage (Hock process) yields acetone + phenol as co-products."},
                     "literature_source": "Ullmann's Encyclopedia of Industrial Chemistry — Acetone (doi:10.1002/14356007.a01_079.pub3)"},
    },
    "isopropanol": {
        "chemical": {"steps": (1, 2),
                     "note": {"de": "Direkte oder indirekte Propylen-Hydratation.",
                              "en": "Direct or indirect propylene hydration."},
                     "literature_source": "Ullmann's Encyclopedia of Industrial Chemistry — Isopropanol (doi:10.1002/14356007.a22_173)"},
    },
    "ethyl acetate": {
        "chemical": {"steps": (1, 2),
                     "note": {"de": "Fischer-Veresterung (EtOH + AcOH) oder Tishchenko-Reaktion aus Acetaldehyd.",
                              "en": "Fischer esterification (EtOH + AcOH) or Tishchenko reaction from acetaldehyde."},
                     "literature_source": "Ullmann's Encyclopedia of Industrial Chemistry — Esters, Organic (doi:10.1002/14356007.a09_565)"},
    },
    "butanol": {
        "chemical": {"steps": (1, 2),
                     "note": {"de": "Oxo-Synthese (Hydroformylierung von Propen) liefert n-Butyraldehyd → Hydrierung.",
                              "en": "Oxo synthesis (hydroformylation of propene) yields n-butyraldehyde → hydrogenation."},
                     "literature_source": "Ullmann's Encyclopedia of Industrial Chemistry — Butanols (doi:10.1002/14356007.a04_463)"},
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "ABE-Fermentation (Acetone-Butanol-Ethanol) mit Clostridium acetobutylicum.",
                                      "en": "ABE fermentation (acetone-butanol-ethanol) with Clostridium acetobutylicum."},
                             "literature_source": "Jones & Woods, Microbiol. Rev. 1986 (doi:10.1128/mr.50.4.484-524.1986)"},
    },
    "isobutanol": {
        "chemical": {"steps": (1, 2),
                     "note": {"de": "Oxo-Synthese (Hydroformylierung von Propen, iso-Selektivität) → Hydrierung.",
                              "en": "Oxo synthesis (hydroformylation of propene, iso-selectivity) → hydrogenation."},
                     "literature_source": "Ullmann's Encyclopedia of Industrial Chemistry — Butanols (doi:10.1002/14356007.a04_463)"},
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Engineered E. coli oder S. cerevisiae mit Ehrlich-Pathway-Modulation.",
                                      "en": "Engineered E. coli or S. cerevisiae with Ehrlich-pathway modulation."},
                             "literature_source": "Atsumi et al., Nature 2008 (doi:10.1038/nature06450)"},
    },
    "2,3-butanediol": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Fermentation mit Klebsiella, Paenibacillus oder engineered E. coli; Aufarbeitung kostentreibend (Hochsieder).",
                                      "en": "Fermentation with Klebsiella, Paenibacillus or engineered E. coli; downstream is cost-driving (high-boiler)."},
                             "literature_source": "Ji et al., Biotechnol. Adv. 2011 (doi:10.1016/j.biotechadv.2011.01.007)"},
    },
    "ethyl lactate": {
        "chemical": {"steps": (1, 2),
                     "note": {"de": "Fischer-Veresterung von Milchsäure mit Ethanol; grünes Lösungsmittel.",
                              "en": "Fischer esterification of lactic acid with ethanol; green solvent."},
                     "literature_source": "Pereira et al., Green Chem. 2011 (doi:10.1039/c0gc00523a)"},
    },
    "diacetyl": {
        "biotechnological": {"steps": (2, 3),
                             "note": {"de": "Lactic-acid-bacteria-Fermentation als Aroma-Nebenprodukt; ggf. mikrobielle Reduktion gehemmt.",
                                      "en": "Lactic-acid-bacteria fermentation as aroma by-product; microbial reduction can be inhibited."},
                             "literature_source": "Hugenholtz et al., Antonie van Leeuwenhoek 2002 (doi:10.1023/A:1020638601038)"},
        "chemical": {"steps": (1, 2),
                     "note": {"de": "Oxidation von 2,3-Butandiol oder MEK → 2,3-Butandion (Diacetyl).",
                              "en": "Oxidation of 2,3-butanediol or MEK → 2,3-butanedione (diacetyl)."},
                     "literature_source": "Ullmann's Encyclopedia of Industrial Chemistry — Ketones (doi:10.1002/14356007.a15_077)"},
    },

    # ---------- small_molecule / non_volatile (additional) ----------
    "glucose": {
        "enzymatic": {"steps": (2, 3),
                      "note": {"de": "Stärke-Hydrolyse mit α-Amylase + Glucoamylase; isomerisierung optional als Folgeschritt.",
                               "en": "Starch hydrolysis with α-amylase + glucoamylase; isomerization optional as follow-up."},
                      "literature_source": "Crabb & Mitchinson, Trends Biotechnol. 1997 (doi:10.1016/S0167-7799(97)01060-2)"},
    },

    # ---------- peptide / linear (SPPS dominant; recombinant where >25 AA) ----------
    "leu-enkephalin": {
        "chemical": {"steps": (6, 9),
                     "note": {"de": "5-mer Tyr-Gly-Gly-Phe-Leu via Fmoc-SPPS; klassisches Forschungs-Peptid.",
                              "en": "5-mer Tyr-Gly-Gly-Phe-Leu via Fmoc-SPPS; classic research peptide."},
                     "literature_source": "Hughes et al., Nature 1975 (doi:10.1038/258577a0) — enkephalin discovery"},
    },
    "met-enkephalin": {
        "chemical": {"steps": (6, 9),
                     "note": {"de": "5-mer Tyr-Gly-Gly-Phe-Met via Fmoc-SPPS.",
                              "en": "5-mer Tyr-Gly-Gly-Phe-Met via Fmoc-SPPS."},
                     "literature_source": "Hughes et al., Nature 1975 (doi:10.1038/258577a0)"},
    },
    "bradykinin": {
        "chemical": {"steps": (10, 14),
                     "note": {"de": "9-mer Arg-Pro-Pro-Gly-Phe-Ser-Pro-Phe-Arg via SPPS.",
                              "en": "9-mer Arg-Pro-Pro-Gly-Phe-Ser-Pro-Phe-Arg via SPPS."},
                     "literature_source": "Bray BL., Nat. Rev. Drug Discov. 2003 (doi:10.1038/nrd1133)"},
    },
    "angiotensin ii": {
        "chemical": {"steps": (9, 13),
                     "note": {"de": "8-mer Asp-Arg-Val-Tyr-Ile-His-Pro-Phe via SPPS.",
                              "en": "8-mer Asp-Arg-Val-Tyr-Ile-His-Pro-Phe via SPPS."},
                     "literature_source": "Bray BL., Nat. Rev. Drug Discov. 2003 (doi:10.1038/nrd1133)"},
    },
    "glucagon": {
        "chemical": {"steps": (30, 36),
                     "note": {"de": "29-mer SPPS — am Rand der wirtschaftlich SPPS-machbaren Sequenzlänge.",
                              "en": "29-mer SPPS — at the edge of the economically SPPS-feasible sequence length."},
                     "literature_source": "Bray BL., Nat. Rev. Drug Discov. 2003 (doi:10.1038/nrd1133); Bromer et al., J. Am. Chem. Soc. 1957 — primary sequence"},
        "biotechnological": {"steps": (4, 6),
                             "note": {"de": "Rekombinant in E. coli als Fusionsprotein; Enterokinase-Spaltung freigesetzt.",
                                      "en": "Recombinant in E. coli as fusion protein; released by enterokinase cleavage."},
                             "literature_source": "Walsh G., Pharmaceutical Biotechnology, 2nd ed. 2018, Wiley (ISBN 978-1-119-11518-7)"},
    },
    "calcitonin": {
        "chemical": {"steps": (33, 38),
                     "note": {"de": "32-mer SPPS mit C-terminal Amid und Disulfidbrücke (Cys1-Cys7).",
                              "en": "32-mer SPPS with C-terminal amide and disulfide bridge (Cys1-Cys7)."},
                     "literature_source": "Guttmann et al., Helv. Chim. Acta 1969 (doi:10.1002/hlca.19690520630)"},
        "biotechnological": {"steps": (4, 6),
                             "note": {"de": "Rekombinant in E. coli oder Hefe als Fusionsprotein.",
                                      "en": "Recombinant in E. coli or yeast as fusion protein."},
                             "literature_source": "Walsh G., Pharmaceutical Biotechnology, 2nd ed. 2018, Wiley (ISBN 978-1-119-11518-7)"},
    },
    "liraglutide": {
        "chemical": {"steps": (33, 40),
                     "note": {"de": "31-mer GLP-1-Analog via SPPS + C16-Palmitoyl-γ-Glutamat-Lipidierung; Novo Nordisk Victoza/Saxenda.",
                              "en": "31-mer GLP-1 analog via SPPS + C16-palmitoyl-γ-glutamate lipidation; Novo Nordisk Victoza/Saxenda."},
                     "literature_source": "Knudsen et al., J. Med. Chem. 2000 (doi:10.1021/jm9909645)"},
    },
    "teriparatide": {
        "chemical": {"steps": (36, 42),
                     "note": {"de": "34-mer PTH(1-34) via SPPS; Forteo-API.",
                              "en": "34-mer PTH(1-34) via SPPS; Forteo API."},
                     "literature_source": "Vaughn et al., J. Pharm. Sci. 1995 (doi:10.1002/jps.2600840509)"},
        "biotechnological": {"steps": (4, 6),
                             "note": {"de": "Rekombinant in E. coli als Forteo-API (Eli Lilly Original-Prozess).",
                                      "en": "Recombinant in E. coli as Forteo API (Eli Lilly original process)."},
                             "literature_source": "Walsh G., Pharmaceutical Biotechnology, 2nd ed. 2018, Wiley (ISBN 978-1-119-11518-7)"},
    },
    "exenatide": {
        "chemical": {"steps": (40, 46),
                     "note": {"de": "39-mer GLP-1-Analog (Exendin-4) via SPPS; Byetta/Bydureon-API.",
                              "en": "39-mer GLP-1 analog (exendin-4) via SPPS; Byetta/Bydureon API."},
                     "literature_source": "Eng et al., J. Biol. Chem. 1992 (doi:10.1016/S0021-9258(18)42531-8)"},
    },

    # ---------- peptide / cyclic (NRPS / SPPS+macrocyclization / echinocandin semi-synthesis) ----------
    "octreotide": {
        "chemical": {"steps": (10, 13),
                     "note": {"de": "8-mer Somatostatin-Analog via SPPS + intramolekulare Disulfidbrücke.",
                              "en": "8-mer somatostatin analog via SPPS + intramolecular disulfide bridge."},
                     "literature_source": "Bauer et al., Life Sci. 1982 (doi:10.1016/0024-3205(82)90087-X)"},
        "biotechnological": {"steps": (4, 6),
                             "note": {"de": "Rekombinante Expression möglich, aber SPPS in der Praxis dominant.",
                                      "en": "Recombinant expression feasible, but SPPS dominates in practice."},
                             "literature_source": "Walsh G., Pharmaceutical Biotechnology, 2nd ed. 2018, Wiley (ISBN 978-1-119-11518-7)"},
    },
    "gramicidin s": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Aneurinibacillus migulanus NRPS-Fermentation; cyclisches Decapeptid.",
                                      "en": "Aneurinibacillus migulanus NRPS fermentation; cyclic decapeptide."},
                             "literature_source": "Kratzschmar et al., J. Bacteriol. 1989 (doi:10.1128/jb.171.10.5422-5429.1989)"},
    },
    "bacitracin": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Bacillus licheniformis Fermentation; gemisch verwandter Cyclo-Peptide (Bacitracin A dominant).",
                                      "en": "Bacillus licheniformis fermentation; mixture of related cyclic peptides (bacitracin A dominant)."},
                             "literature_source": "Konz et al., J. Biol. Chem. 1997 (doi:10.1074/jbc.272.3.1546)"},
    },
    "vancomycin": {
        "biotechnological": {"steps": (3, 5),
                             "note": {"de": "Amycolatopsis orientalis NRPS-Fermentation; Glykopeptid mit 7-mer Heptapeptid-Aglycon.",
                                      "en": "Amycolatopsis orientalis NRPS fermentation; glycopeptide with 7-mer heptapeptide aglycone."},
                             "literature_source": "van Wageningen et al., Chem. Biol. 1998 (doi:10.1016/S1074-5521(98)90060-6)"},
    },
    "daptomycin": {
        "biotechnological": {"steps": (3, 5),
                             "note": {"de": "Streptomyces roseosporus NRPS-Fermentation; cyclisches 13-mer Lipopeptid.",
                                      "en": "Streptomyces roseosporus NRPS fermentation; cyclic 13-mer lipopeptide."},
                             "literature_source": "Miao et al., Microbiology 2005 (doi:10.1099/mic.0.27757-0)"},
    },
    "polymyxin b": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Paenibacillus polymyxa NRPS-Fermentation; cyclisches Lipopeptid-Gemisch B1/B2/B3.",
                                      "en": "Paenibacillus polymyxa NRPS fermentation; cyclic lipopeptide mixture B1/B2/B3."},
                             "literature_source": "Choi et al., J. Bacteriol. 2009 (doi:10.1128/JB.00060-09)"},
    },
    "colistin": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Paenibacillus polymyxa Fermentation; cyclisches Lipopeptid (Polymyxin E).",
                                      "en": "Paenibacillus polymyxa fermentation; cyclic lipopeptide (polymyxin E)."},
                             "literature_source": "Velkov et al., J. Med. Chem. 2010 (doi:10.1021/jm900999h)"},
    },
    "caspofungin": {
        "chemical": {"steps": (5, 8),
                     "note": {"de": "Semi-Synthese aus Pneumocandin B0 (Glarea-Fermentationsprodukt) + Acylierung + Aminierung.",
                              "en": "Semi-synthesis from pneumocandin B0 (Glarea fermentation product) + acylation + amination."},
                     "literature_source": "Balkovec et al., Nat. Prod. Rep. 2014 (doi:10.1039/c3np70069k)"},
    },
    "anidulafungin": {
        "chemical": {"steps": (4, 7),
                     "note": {"de": "Semi-Synthese aus Echinocandin B0 (Aspergillus nidulans) + Seitenketten-Austausch.",
                              "en": "Semi-synthesis from echinocandin B0 (Aspergillus nidulans) + side-chain exchange."},
                     "literature_source": "Debono et al., J. Med. Chem. 1995 (doi:10.1021/jm00018a008)"},
    },

    # ---------- protein / antibody (uniform CHO mAb manufacturing platform) ----------
    "adalimumab": {
        "biotechnological": {"steps": (5, 8),
                             "note": {"de": "CHO-Fed-Batch + Protein A + niedrigem pH-Virusinaktivierung + AEX/CEX + Virusfiltration + UF/DF.",
                                      "en": "CHO fed-batch + Protein A + low-pH viral inactivation + AEX/CEX + viral filtration + UF/DF."},
                             "literature_source": "Liu et al., mAbs 2010 (doi:10.4161/mabs.2.5.12796); Kelley B., MAbs 2009 (doi:10.4161/mabs.1.5.9448)"},
    },
    "trastuzumab": {
        "biotechnological": {"steps": (5, 8),
                             "note": {"de": "CHO-Fed-Batch + Standard-Antikörper-Plattform (Protein A → AEX/CEX → VRF → UF/DF).",
                                      "en": "CHO fed-batch + standard antibody platform (Protein A → AEX/CEX → VRF → UF/DF)."},
                             "literature_source": "Liu et al., mAbs 2010 (doi:10.4161/mabs.2.5.12796)"},
    },
    "rituximab": {
        "biotechnological": {"steps": (5, 8),
                             "note": {"de": "CHO-Fed-Batch + Standard-Antikörper-Plattform.",
                                      "en": "CHO fed-batch + standard antibody platform."},
                             "literature_source": "Liu et al., mAbs 2010 (doi:10.4161/mabs.2.5.12796)"},
    },
    "bevacizumab": {
        "biotechnological": {"steps": (5, 8),
    ...
    "infliximab": {
        "biotechnological": {"steps": (5, 8),
                             "note": {"de": "SP2/0-Mausmyelom-Linie (Original) oder CHO bei Biosimilars; sonst Standard-Plattform.",
                                      "en": "SP2/0 mouse myeloma line (original) or CHO for biosimilars; otherwise standard platform."},
                             "literature_source": "Liu et al., mAbs 2010 (doi:10.4161/mabs.2.5.12796)"},
    },
    "nivolumab": {
        "biotechnological": {"steps": (5, 8),
    ...
    "cetuximab": {
        "biotechnological": {"steps": (5, 8),
                             "note": {"de": "SP2/0-Mausmyelom-Linie + Standard-DSP; chimäre Antikörperstruktur.",
                                      "en": "SP2/0 mouse myeloma line + standard DSP; chimeric antibody structure."},
                             "literature_source": "Liu et al., mAbs 2010 (doi:10.4161/mabs.2.5.12796)"},
    },
    "pertuzumab": {
        "biotechnological": {"steps": (5, 8),
    ...
    "etanercept": {
        "biotechnological": {"steps": (5, 8),
                             "note": {"de": "CHO-Fed-Batch + Standard-Fc-Fusion-DSP (Protein A bindet die IgG1-Fc-Domäne).",
                                      "en": "CHO fed-batch + standard Fc-fusion DSP (Protein A binds the IgG1 Fc domain)."},
                             "literature_source": "Liu et al., mAbs 2010 (doi:10.4161/mabs.2.5.12796); Walsh G., Nat. Biotechnol. 2018 (doi:10.1038/nbt.4313)"},
    },

    # ---------- protein / enzyme (industrial — Bacillus/Aspergillus/Trichoderma platforms) ----------
    "amylase": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Bacillus licheniformis oder B. subtilis submerse Fermentation + UF + Stabilisator-Formulierung.",
                                      "en": "Bacillus licheniformis or B. subtilis submerged fermentation + UF + stabilizer formulation."},
                             "literature_source": "Pandey et al., Biotechnol. Appl. Biochem. 2000 (doi:10.1042/BA19990073)"},
    },
    "lipase": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Aspergillus niger oder Rhizomucor miehei Fermentation; Novozymes-Plattform (CalB / Lipozyme).",
                                      "en": "Aspergillus niger or Rhizomucor miehei fermentation; Novozymes platform (CalB / Lipozyme)."},
                             "literature_source": "Chapman et al., Catalysts 2018 (doi:10.3390/catal8060238)"},
    },
    "protease": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Bacillus subtilis subtilisin oder Bacillus licheniformis Fermentation + UF; Detergens-Anwendung dominant.",
                                      "en": "Bacillus subtilis subtilisin or Bacillus licheniformis fermentation + UF; detergent application dominant."},
                             "literature_source": "Gupta et al., Appl. Microbiol. Biotechnol. 2002 (doi:10.1007/s00253-002-0975-y)"},
    },
    "cellulase": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Trichoderma reesei Fermentation; Multi-Enzym-Mischung mit Endo-, Exo-Glucanasen und β-Glucosidase.",
                                      "en": "Trichoderma reesei fermentation; multi-enzyme mix with endo-, exo-glucanases and β-glucosidase."},
                             "literature_source": "Bischof et al., Microb. Cell Fact. 2016 (doi:10.1186/s12934-016-0507-6)"},
    },
    "lactase": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Kluyveromyces lactis oder Aspergillus oryzae Fermentation + UF; intrazellulär bei K. lactis (Zellaufschluss nötig).",
                                      "en": "Kluyveromyces lactis or Aspergillus oryzae fermentation + UF; intracellular in K. lactis (cell lysis required)."},
                             "literature_source": "Saqib et al., Biotechnol. Adv. 2017 (doi:10.1016/j.biotechadv.2017.05.003)"},
    },
    "phytase": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Aspergillus niger oder Pichia pastoris Fermentation; Futtermittelzusatz, hohe Tonnagen.",
                                      "en": "Aspergillus niger or Pichia pastoris fermentation; feed additive, high tonnages."},
                             "literature_source": "Lei et al., Annu. Rev. Anim. Biosci. 2013 (doi:10.1146/annurev-animal-031412-103717)"},
    },
    "pectinase": {
        "biotechnological": {"steps": (2, 4),
                             "note": {"de": "Aspergillus niger Fermentation; Saft- und Wein-Industrie, multikomponenten-Formulierung.",
                                      "en": "Aspergillus niger fermentation; juice and wine industry, multi-component formulation."},
                             "literature_source": "Jayani et al., Process Biochem. 2005 (doi:10.1016/j.procbio.2005.03.026)"},
    },
    "erythropoietin": {
        "biotechnological": {"steps": (5, 7),
                             "note": {"de": "CHO-Fed-Batch + IEX + Reverse-Phase + Iso-Form-Trennung (Glykoform-Heterogenität) + UF/DF.",
                                      "en": "CHO fed-batch + IEX + reverse-phase + iso-form separation (glycoform heterogeneity) + UF/DF."},
                             "literature_source": "Jelkmann W., Internal Medicine 2004 (doi:10.2169/internalmedicine.43.649); Walsh G., Nat. Biotechnol. 2018 (doi:10.1038/nbt.4313)"},
    },
    "filgrastim": {
        "biotechnological": {"steps": (4, 6),
                             "note": {"de": "E. coli Inklusion-Body-Refolding + IEX + SEC + UF/DF; Neupogen-API.",
                                      "en": "E. coli inclusion-body refolding + IEX + SEC + UF/DF; Neupogen API."},
                             "literature_source": "Walsh G., Pharmaceutical Biotechnology, 2nd ed. 2018, Wiley (ISBN 978-1-119-11518-7)"},
    },
    "somatropin": {
        "biotechnological": {"steps": (4, 6),
                             "note": {"de": "E. coli mit periplasmatischer Sekretion oder Refolding-Pfad; Humatrope/Genotropin-API.",
                                      "en": "E. coli with periplasmic secretion or refolding pathway; Humatrope/Genotropin API."},
                             "literature_source": "Walsh G., Pharmaceutical Biotechnology, 2nd ed. 2018, Wiley (ISBN 978-1-119-11518-7)"},
    },

    # ---------- natural_product / terpene (additional extraction & engineered microbial) ----------
    "menthol": {
        "extraction": {"steps": (2, 4),
                       "note": {"de": "Aus Mentha arvensis-Öl via Kristallisation oder Tieftemperatur-Trennung.",
                                "en": "From Mentha arvensis oil via crystallization or low-temperature separation."},
                       "literature_source": "Bauer, Garbe, Surburg, Common Fragrance & Flavor Materials 5th ed., Wiley-VCH 2006 (ISBN 978-3-527-31150-9)"},
        "chemical": {"steps": (4, 7),
                     "note": {"de": "Asymmetrische Hydrierung von Citronellal (Symrise/Takasago-Prozess) → Menthol.",
                              "en": "Asymmetric hydrogenation of citronellal (Symrise/Takasago process) → menthol."},
                     "literature_source": "Noyori R., Adv. Synth. Catal. 2003 (doi:10.1002/adsc.200390011) — Takasago menthol process"},
    },
    "geraniol": {
        "extraction": {"steps": (2, 4),
                       "note": {"de": "Aus Rosen-, Palmarosa- oder Citronella-Öl via Destillation.",
                                "en": "From rose, palmarosa or citronella oil via distillation."},
                       "literature_source": "Bauer, Garbe, Surburg, Common Fragrance & Flavor Materials 5th ed., Wiley-VCH 2006 (ISBN 978-3-527-31150-9)"},
        "chemical": {"steps": (3, 5),
                     "note": {"de": "Selektive Hydrierung von Citral (BASF-Prozess) → Geraniol/Nerol-Mischung.",
                              "en": "Selective hydrogenation of citral (BASF process) → geraniol/nerol mixture."},
                     "literature_source": "Bauer, Garbe, Surburg, Common Fragrance & Flavor Materials 5th ed., Wiley-VCH 2006 (ISBN 978-3-527-31150-9)"},
    },
    "α-pinene": {
        "extraction": {"steps": (1, 3),
                       "note": {"de": "Aus Terpentinöl (Pinus pinaster) via fraktionierter Destillation.",
                                "en": "From turpentine oil (Pinus pinaster) via fractional distillation."},
                       "literature_source": "Erman & Kane, Chem. Biodivers. 2008 (doi:10.1002/cbdv.200890087)"},
    },
    "squalene": {
        "extraction": {"steps": (2, 4),
                       "note": {"de": "Aus Olivenöl-Desodorierungs-Destillat oder Amaranth-Öl; Haileberöl historisch (heute selten).",
                                "en": "From olive oil deodorizer distillate or amaranth oil; shark liver oil historic (now rare)."},
                       "literature_source": "Popa et al., Cosmetics 2015 (doi:10.3390/cosmetics2020162)"},
        "biotechnological": {"steps": (3, 5),
                             "note": {"de": "Engineered Yarrowia lipolytica oder Saccharomyces cerevisiae mit MVA-Pathway-Hochregulation.",
                                      "en": "Engineered Yarrowia lipolytica or Saccharomyces cerevisiae with MVA-pathway upregulation."},
                             "literature_source": "Paramasivan & Mutturi, J. Agric. Food Chem. 2017 (doi:10.1021/acs.jafc.7b03390)"},
    },
    "artemisinin": {
        "extraction": {"steps": (3, 5),
                       "note": {"de": "Aus Artemisia annua Blattmaterial via Lösungsmittelextraktion + Kristallisation; jährliche Ernteschwankungen.",
                                "en": "From Artemisia annua leaf material via solvent extraction + crystallization; annual harvest fluctuations."},
                       "literature_source": "Hsu E., Br. J. Clin. Pharmacol. 2006 (doi:10.1111/j.1365-2125.2006.02746.x); WHO Monograph Artemisia annua"},
        "biotechnological": {"steps": (4, 6),
                             "note": {"de": "Amyris/Sanofi semi-synthetisch: Hefe-Fermentation von Artemisinsäure + chemische Reduktion.",
                                      "en": "Amyris/Sanofi semi-synthetic: yeast fermentation of artemisinic acid + chemical reduction."},
                             "literature_source": "Paddon et al., Nature 2013 (doi:10.1038/nature12051)"},
    },

    # ---------- natural_product / alkaloid (additional extraction) ----------
    "codeine": {
        "extraction": {"steps": (3, 5),
                       "note": {"de": "Aus Mohnstroh via gemeinsame Alkaloid-Extraktion mit Morphin; oder semi-synthetisch durch 3-O-Methylierung von Morphin.",
                                "en": "From poppy straw via joint alkaloid extraction with morphine; or semi-synthetic via 3-O-methylation of morphine."},
                       "literature_source": "Kutchan, The Alkaloids 1998 (doi:10.1016/S0099-9598(08)60052-6); Beaudoin & Facchini, Planta 2014 (doi:10.1007/s00425-014-2056-8)"},
        "chemical": {"steps": (2, 4),
                     "note": {"de": "Semi-Synthese aus Morphin durch selektive Methylierung der 3-Phenol-Gruppe.",
                              "en": "Semi-synthesis from morphine via selective methylation of the 3-phenol group."},
                     "literature_source": "Rinner & Hudlicky, Topics in Current Chemistry 2012 (doi:10.1007/128_2011_309)"},
    },
    "atropine": {
        "extraction": {"steps": (3, 5),
                       "note": {"de": "Aus Atropa belladonna oder Datura stramonium via saure Extraktion + Reinigung als Sulfat.",
                                "en": "From Atropa belladonna or Datura stramonium via acidic extraction + purification as sulfate salt."},
                       "literature_source": "Kohnen-Johannsen & Kayser, Molecules 2019 (doi:10.3390/molecules24040796)"},
    },
    "quinine": {
        "extraction": {"steps": (3, 5),
                       "note": {"de": "Aus Cinchona-Rinde via klassische saure Extraktion + Salzbildung als Sulfat oder Bisulfat.",
                                "en": "From cinchona bark via classical acidic extraction + salt formation as sulfate or bisulfate."},
                       "literature_source": "Kacprzak K., Heterocycles 2013 (doi:10.3987/REV-13-768)"},
    },
}
